...
//    @Test
    ...
    public void createSession() {
        ...
        //对请求参数列表进行签名
        String sign = OspUtils.sign(form.toSingleValueMap(), "abcdeabcdeabcdeabcdeabcde");
        form.add("sign", sign);
...
//        form.add("fileType", "EXCEL");
    ...
    public void testQueryUserByUserId() {
        ...
        //对请求参数列表进行签名
        String sign = OspUtils.sign(form, "abcdeabcdeabcdeabcdeabcde");
        form.put("sign", sign);
...
//        form.add("favorites", "\"aa\",\"bb\",\"cc\"");
    ...
    /**
     * 由于{@link com.knowlegene.sample.request.CreateUserRequest#password}标注了{@link IgnoreSign},所以Rop
...
//        form.add("sign", sign);
    ...
    public void testI18nErrorMessage() {
        ...
        //对请求参数列表进行签名
        form.put("sign", OspUtils.sign(form, "abcdeabcdeabcdeabcdeabcde"));
    ...
    public void testViolationServiceAccessController() {
        ...
        //设置一个错误的签名
        String sign = OspUtils.sign(form.toSingleValueMap(), "abcdeabcdeabcdeabcdeaaaaa");
        form.add("sign", sign);
