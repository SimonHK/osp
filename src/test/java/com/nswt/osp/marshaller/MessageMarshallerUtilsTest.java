...
public class MessageMarshallerUtilsTest {
    ...
    public void testMarshallerOspRequest() throws Exception {
        ...
        when(ospRequest.getOspRequestContext()).thenReturn(msc);
        HashMap<String, String> map = new HashMap<String, String>();
        map.put("key1", "key1Value");
        map.put("key2", "key2Value");
        map.put("key3", "key3Value");
        when(msc.getAllParams()).thenReturn(map);
        String message = MessageMarshallerUtils.getMessage(ospRequest, MessageFormat.json);
        ...
        message = MessageMarshallerUtils.getMessage(ospRequest, MessageFormat.xml);
        assertNotNull(message);
        assertTrue(message.indexOf("<") > -1);
        assertTrue(message.indexOf(">") > -1);
        assertTrue(message.indexOf("key1") > -1);
    ...
    @Test
    public void testMarshallerOspResponse() throws Exception {
