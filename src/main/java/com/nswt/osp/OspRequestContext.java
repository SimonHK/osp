...
/**
 * <pre>
 *    接到服务请求后，将产生一个{@link OspRequestContext}上下文对象，它被本次请求直到返回响应的这个线程共享。
 * </pre>
 *
 * @author Admin
 * @version 1.0
 */
public interface OspRequestContext {
     ...
     * @param ospResponse
     */
    void setOspResponse(Object ospResponse);
