...
public class OspUtils {
    ...
    private static final Logger logger = LoggerFactory.getLogger(OspUtils.class);
    ...
    public static String sign(Map<String, String> paramValues, List<String> ignoreParamNames,String secret) {
        try {
            ...
            List<String> igother = new ArrayList<String>();
            igother.add(0,"_");
            igother.add(1,"__invoke");
            for (String si : igother){
                paramNames.remove(si);
            }
